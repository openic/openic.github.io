...
}}var e={global:"https://www.apple.com"+h+"/search/",ipad:"https://www.apple.com"+h+"/search/",iphone:"https://www.apple.com"+h+"/search/",ipoditunes:"https://www.apple.com"+h+"/search/",mac:"https://www.apple.com"+h+"/search/",store:"https://www.apple.com"+h+"/search/",support:"http://www.info.apple.com/searchredir.html"};
if(typeof(window.searchHost)!=="undefined"&&window.searchHost===true){var g=window.location.protocol+"//"+window.location.hostname;
if(searchSection!=="support"){var f=e[searchSection].replace("https://www.apple.com",g)
}}else{var f=e[searchSection]||"https://www.apple.com/search/"}this.globalSearchForm.setAttribute("action",f);
...
if(typeof(window.searchHost)!=="undefined"&&window.searchHost===true){this.data.url=decodeURIComponent(this.data.url).replace("https://www.apple.com",r);
...
return this};SearchShortcut.quickLinks=function(){this.baseShortcutsUrl="https://www.apple.com/global/nav/scripts/shortcuts.php"
...
this.aiGetSuggestionsUrl=c+"/search/instant/getSuggestions"}else{this.aiGetSuggestionsUrl="https://www.apple.com/search/instant/getSuggestions"
